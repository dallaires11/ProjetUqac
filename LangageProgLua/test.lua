...
function fight()
	...
	if(spaceMarine.pv<=0 and tyranide.pv<=0) then
		...
		victoireG = victoireG+1
		victoireSM = victoireSM+1
...
function map()
	local test2
	while(true) do 
		for i=0,maxTabY,1 do
			test2 = ""
			for j=0,maxTabX,1 do
				if(j==spaceMarine.posX and j==tyranide.posX and i==spaceMarine.posY and j==tyranide.posY)then
					test2 = test2.."X"
				elseif(i==spaceMarine.posX and j==tyranide.posX)then
					test2 = test2.."S"
				elseif(i==spaceMarine.posY and j==tyranide.posY) then
					test2 = test2.."T"
				else
					test2 = test2.."-"
				end
...
--[[while not(test1==nombreMatch) do
	endGame=false
	enCombat=false
	tyranide.posX = 19
    tyranide.posY = 19
...
--print("Victoire xenos "..victoireG.."\n")
--print("Victoire de l'imperium "..victoireSM.."\n")
